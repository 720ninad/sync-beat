...
function WaveBar({ delay }: { delay: number }) {
  ...
  return (
    <Animated.View
      style={[s.waveBar, { transform: [{ scaleY: anim }], opacity: anim }]}
    />
  );
}
    ...
    <View style={s.container}>
          ...
          <View>
            ...
            <View style={s.connectedRow}>
              <View
                style={[
                  s.connDot,
                  { backgroundColor: isConnected ? "#2DD4BF" : "#FBBF24" },
                ]}
              />
              <Text
                style={[
                  s.connText,
                  { color: isConnected ? "#2DD4BF" : "#FBBF24" },
                ]}
              >
      ...
      <View style={s.banner}>
        ...
        <Text style={s.bannerSub}>
          Both of you will hear it at the exact same time
        </Text>
      </View>
